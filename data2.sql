...
INSERT IGNORE INTO `auth_user`(`id`, `password`, `last_login`, `is_superuser`, `first_name`, `last_name`, `email`, `is_staff`, `is_active`, `date_joined`, `username`) VALUES(1, 'pbkdf2_sha256$36000$TUtfiG7SmPyJ$G5CP7VexAURmjBHpx1BdXODKBS7AevqkySG0bLnD4aY=', '2018-09-22 11:48:11.400907', 1, "", "", 'admin@gmail.com', 1, 1, '2017-12-11 11:09:06.028968', 'admin'), (2, 'pbkdf2_sha256$36000$49VmNkuyWejE$ZAnD0U2NSFVh0CxrepTazsMKM5HlJ39qzwl4bGdAXis=', '2018-02-13 10:34:59.283802', 0, "", "", "", 1, 1, '2018-02-13 10:33:00', 'Aftab'), (3, 'pbkdf2_sha256$36000$QbnPpK3IXKpj$TW4Py2sGdSYLWXuR5pFEnT7ewHGntq4CYLgA1k62xFc=', NULL, 1, "", "", 'surhan@gmail.com', 1, 1, '2018-07-20 12:24:02.795124', 'surhan');
UNLOCK TABLES;
...
INSERT IGNORE INTO `slider_clo`(`id`, `link`, `title`) VALUES(2, 'https://www.w3schools.com/bootstrap/bootstrap_buttons.asp', 'Electrical'), (3, 'https://www.w3schools.com/bootstrap/bootstrap_buttons.asp', 'Civil'), (4, 'https://docs.google.com/spreadsheets/d/1TlYCy7JSoflUXMp_62lvRmzAIxQX0se5CUIfo_x_3iw/edit?ts=5acc58e9#gid=896371080', 'Computing');
UNLOCK TABLES;
...
INSERT IGNORE INTO `slider_event`(`id`, `picture`, `title`, `description`, `timestamp`) VALUES(1, 'images/logo.png', 'ANSEC 18 Coming Soon', 'ANSEC 18 Coming Soon', '2018-09-03 10:54:53'), (2, 'images/orientation.jpeg', 'Orientation Session Fall 18', 'Orientation Session Fall 18 will be held on 27th August 2018 at Main Auditorium, AUIC.', '2018-08-27 09:00:00'), (3, 'images/38125799_2142134129333482_6496561974241918976_n.jpg', 'Entry Test Fall - 18', 'Abasyn University Islamabad Campus warmly welcome to all the candidates for entry test Fall 18.AUIC is going to provide', '2018-08-02 09:00:00');
UNLOCK TABLES;
...
INSERT IGNORE INTO `slider_message`(`id`, `message`) VALUES(1, 'Admissions are open');
UNLOCK TABLES;
...
INSERT IGNORE INTO `slider_new`(`id`, `picture`, `title`, `description`, `timestamp`, `link`) VALUES(1, 'images/AUIC-Logo.png', 'Result Summer 18', 'AUIC announced result of Summer 18.', '2018-09-03 13:12:42', '#');
UNLOCK TABLES;
...
CREATE TABLE `slider_slider` (
  `id` INT NOT NULL,
  `slider1` VARCHAR(100) CHARACTER SET utf8 NOT NULL,
  `slider2` VARCHAR(100) CHARACTER SET utf8 NOT NULL,
  `slider3` VARCHAR(100) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM;
...
INSERT IGNORE INTO `slider_slider`(`id`, `slider1`, `slider2`, `slider3`) VALUES(1, 'images/36824594_2117287088484853_4833747608725880832_n_2EQSQV4.jpg', 'images/25398107_2008323612714535_6504903865486525119_o.jpg', 'images/contact.jpeg');
UNLOCK TABLES;
...
CREATE TABLE `slider_staff` (
  ...
  `twiter` TEXT CHARACTER SET utf8 NOT NULL,
...
INSERT IGNORE INTO `slider_staff`(`id`, `name`, `designation`, `qualification`, `profile`, `twiter`, `department`) VALUES(2, 'Dr Sidra Sultana', 'HoD Department of Computing', 'PhD, Military College of Signals, NUST  MS (Computer Software Engineering), Military College of Signals', 'images/4.jpg', 'null', 'computing'), (3, 'Dr. Amjad Mahmood', 'Professor/ Executive Director', 'Ph.D., Computer Science, University of London, United Kingdom M.Sc., Computer Science Quaid-i-Azam University, Islamabad', 'images/7.jpg', 'null', 'computing'), (4, 'Dr. M. Yousaf Khan', 'Associate Professor', 'PhD (Software Engineering), Abertay University, Dundee, Scotland, UK  M.Phil (Software Engineering), Abertay University,', 'images/6.jpg', 'null', 'computing'), (5, 'Ms. Sameen Javed', 'Lecturer', 'MS (Software Engineering) NUST, Pakistan  BS (Software Engineering) FJWU, Rawalpindi', 'images/sameen.jpg', 'null', 'computing'), (6, 'Ms. Naveen Ahmed', 'Lecturer', 'MS Software Engineering', 'images/naveenahmed_.jpg', 'null', 'computing'), (7, 'Ms. Madiha Naveed', 'Lab Engineer', 'BS Computer Science', 'images/madihanaveed.jpg', 'null', 'computing'), (9, 'Dr. M. Noman Jafri', 'Professor/ Dean of Engineering and Computing', 'PhD (Electrical Engineering), University of Ottawa, Canada MSc (Electrical Engineering), University of Ottawa, Canada BS', 'images/Dr._M.Noman_Jafri.jpg', 'null', 'electrical'), (10, 'Dr. I.S. Awan', 'none', 'PhD (Computer Engineering)', 'images/imran_shafi.jpg', 'null', 'electrical'), (11, 'Dr. M. Salik Javaid', 'Professor/ HoD Dept. of Civil Engineering', 'PhD (Civil Engineering), Georgia Institute of Technology, Atlanta, GA, USA MSc (Civil Engineering), Georgia Institute of', 'images/Dr._Salik_Javaid.png', 'null', 'civil'), (12, 'Mr. Zeeshan Ullah', 'Assistant Professor', 'PhD Scholar (Construction Engineering & Management) NUST, Islamabad  M.Sc Construction Engineering and Management, The S', 'images/Zeeshan1.jpg', 'null', 'civil'), (13, 'Ms. Naheed Akhtar', 'Assistant Professor', 'MS Environmental Engineering, UET, Taxila  BS Civil Engineering, UET, Taxila', 'images/Naheed11.jpg', 'null', 'civil'), (14, 'Ms. Laila Khalid', 'Assistant Professor', 'PhD Scholar (Water Resource Engineering) CUST, Islamabad Msc Geotechnical Engineering, NUST BSc Civil Engineering, BZU,', 'images/Laila.Khalid.jpg', 'null', 'civil');
UNLOCK TABLES;
...
INSERT IGNORE INTO `slider_timetablegraduate`(`id`, `link`) VALUES(1, 'https://www.w3schools.com/bootstrap/bootstrap_buttons.asp');
UNLOCK TABLES;
...
INSERT IGNORE INTO `sqlite_sequence`(`name`, `seq`) VALUES('django_migrations', 49), ('django_admin_log', 139), ('django_content_type', 27), ('auth_permission', 81), ('auth_user', 3), ('slider_slider', 1), ('auth_user_user_permissions', 1), ('slider_event', 4), ('alumni_alumni', 2), ('slider_fees', 28), ('slider_acdamic_calander', 2), ('slider_staff', 14), ('slider_timetable', 1), ('slider_new', 1), ('slider_online_admission', 1), ('auth_group', 1), ('auth_group_permissions', 2), ('Ansec_orgnizers', 0), ('slider_clo', 4), ('slider_message', 1), ('slider_timetablegraduate', 1), ('slider_download', 3), ('slider_permission', 4);
UNLOCK TABLES;
